...
if 'user_info' not in st.session_state:
    ...
    unselected_menu = st.session_state.menu
    ...
    if selected_menu == "Home":
        ...
        # Hindi translations for crop information fields
        HINDI_TRANSLATIONS = {
            "climate": "जलवायु",
            "soil": "मिट्टी",
            "fertilizers": "उर्वरक",
            "time_periods": "समय अवधि",
            "best_practices": "सर्वोत्तम अभ्यास",
            "note": "नोट",
            "Climate Requirements": "जलवायु आवश्यकताएँ",
            "Soil Requirements": "मिट्टी की आवश्यकताएँ",
            "Fertilizers": "उर्वरक",
            "Time Periods": "समय अवधि",
            "Best Practices": "सर्वोत्तम अभ्यास",
            "Note": "नोट",
            "Smart Farming Guidance for": "के लिए स्मार्ट खेती मार्गदर्शन",
            "in": "में",
            "Sorry, detailed guidance for": "क्षमा करें, इसके लिए विस्तृत मार्गदर्शन",
            "is not available in the database. General advice: Use balanced NPK fertilizers (20-20-20), ensure proper irrigation, and plant during the optimal season for your region.": "डेटाबेस में उपलब्ध नहीं है। सामान्य सलाह: संतुलित एनपीके उर्वरक (20-20-20) का उपयोग करें, उचित सिंचाई सुनिश्चित करें, और अपने क्षेत्र के लिए इष्टतम मौसम में रोपण करें।"
        }

        # Crop-specific translations (expand as needed)
        CROP_TRANSLATIONS = {
            "wheat": "गेहूं",
            "rice": "चावल",
            "maize": "मक्का",
        ...
        if submitted:
            if crop and country:
                with st.spinner("🔍 Fetching guidance..."):
                    ...
                    if language == "Hindi":
                        # Translate the guidance to Hindi
                        crop_lower = crop.lower()
                        crop_hindi = CROP_TRANSLATIONS.get(crop_lower, crop)  # Default to English name if not translated
                        country_hindi = country  # Add country translations if needed (e.g., "India": "भारत")
                        
                        # Replace English terms with Hindi equivalents
                        hindi_guidance = guidance
                        for eng, hin in HINDI_TRANSLATIONS.items():
                            hindi_guidance = hindi_guidance.replace(eng, hin)
                        hindi_guidance = hindi_guidance.replace(crop.capitalize(), crop_hindi)
                        hindi_guidance = hindi_guidance.replace(country, country_hindi)
                        
                        st.markdown(f"<div style='text-align: center;'>{hindi_guidance}</div>", unsafe_allow_html=True)
                    else:
                        # Display in English
